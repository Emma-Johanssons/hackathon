...
def git_glossary():
    data = load_data()
    git_questions = data.get("quiz", {}).get("git", [])

    # Shuffle the questions at the start of the quiz
    random.shuffle(git_questions)

    # Shuffle the options for each question
    for question in git_questions:
    ...
    total_questions = len(git_questions)
    ...
    if st.session_state.question_index < total_questions:
        ...
        item = git_questions[st.session_state.question_index]
